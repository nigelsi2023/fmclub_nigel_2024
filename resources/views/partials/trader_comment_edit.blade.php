                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-left">
                            <!-- TITLE-->
                            <h2 class="text-uppercase" data-animated="fadeInLeftBig" data-animation-delay="400">Trader Comment Edit</h2>
                            <!-- BREADCRUMB-->
                            <ul class="breadcrumb">
                                <li>
            	...
            	<div class="container">
	            	<div class="row">
	            		<div class="col-md-8 col-md-offset-2">
	            			<form method="post" action="{{ route('trader_comment.update', $comment->id) }}">
	            				@csrf

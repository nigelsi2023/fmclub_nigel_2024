@foreach($comments as $comment)
    ...
    <div class="">
            ...
            <div class="panel-heading">
                @if($comment->user_id == Auth::id())
                    <div class="pull-right">
                        ...
                        <a href="{{ route('trader_comment.edit', $comment->id) }}">Edit</a>
                        /
                        <a style="color: red;" href="{{ route('trader_comment.delete', $comment->id) }}">Delete</a>
                    </div>
                @endif
        ...
        <p>{{ $comment->body }}</p> -->
        @auth
        <form method="post" action="{{ route('trader_reply.add') }}">
            @csrf
        ...
        <div class="padding-left-40">
            @include('partials.trader_comment_replies', ['comments' => $comment->replies])
        </div>

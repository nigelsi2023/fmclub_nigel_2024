                ...
                <div class="container" style="margin-top: 20px;margin-bottom: 20px;">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3" >
                            <!-- <div class="pull-left">
                                <a class="btn typo-light btn-square btn-hv-dark theme-bg" href="{{ route('market-analysis') }}">Refresh</a>
                            </div>
                            <div class="pull-right">
                                <a class="btn typo-light btn-square btn-hv-dark theme-bg" href="{{ route('products.create') }}"> Create New Product</a>
                            </div> -->
                                ...
                                <form action="{{ route('products.store') }}" method="POST" class="form-inline">
                                    ...
                                    <div class="form-group">
                                        <div class="input-email form-group has-feedback">
                                            <select class="js-example-basic-single input-subject form-control" name="name">
                                            ...
                                            <button type="submit" class="btn typo-light btn-hv-dark theme-bg btn-sm">Create</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <div class="container">
        <div class="col-md-12">
            ...
            <ul class="nav nav-tabs">
                ...
                <li><a data-toggle="tab" href="#myfav">My Watch List</a></li>
            ...
            <div class="tab-content bottom-margin-sm">
                ...
                <div id="myfav" class="tab-pane fade">
                    <h3>My Watch List</h3>
                    <table class="table ">
                        <thead>
                            <!-- <th>Logo</th> -->

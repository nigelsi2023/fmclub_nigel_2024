        ...
        <ul class="navbar-nav ml-auto mr-0 mr-md-3 my-2 my-md-0">
            <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                    ...
                    <img src="{{ asset('uploads/default.png') }}" width="20" height="20" style="border-radius: 50%;"
                        alt="Profile Image">
                    @elseif(Auth::user()->image == '')
                    <img src="{{ asset('uploads/default.png') }}" width="20" height="20" style="border-radius: 50%;"
                        alt="Profile Image">
                    @else
                    <img src="{{ asset('uploads/users/'.Auth::user()->image) }}" width="20" height="20"
                        style="border-radius: 50%">
                    @endif
                    <b class="text-white text-uppercase">{{ Auth::user()->name }}</b>
                </a>
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                    ...
                    <a class="dropdown-item {{ Request::is('admin/profile')? 'active': '' }}"
                        ...
                        @if(Auth::user()->image == 'default.png')
                        <img src="{{ asset('uploads/default.png') }}" width="25" height="25" style="border-radius: 50%;"
                            alt="Profile Image">
                        @elseif(Auth::user()->image == '')
                        <img src="{{ asset('uploads/default.png') }}" width="25" height="25" style="border-radius: 50%;"
                            alt="Profile Image">
                        @else
                        <img src="{{ asset('uploads/users/'.Auth::user()->image) }}" width="25" height="25"
                            style="border-radius: 50%">
                        @endif

                        {{ Auth::user()->name }}
                    </a>
                    <a class="dropdown-item {{ Request::is('admin/account-settings')? 'active': '' }}"
                        href="{{ route('admin.account') }}"><i class="fas fa-user-cog"></i> Account Settings</a>
        ...
        <ul class="sidebar navbar-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                    <a class="dropdown-item {{ Request::is('admin/admins')? 'active': '' }}"
                        href="{{ route('admin.index') }}">
                        <i class="fas fa-fw fa-users-cog"></i>
                        <span>Admins</span>
                    </a>

                    <a class="dropdown-item {{ Request::is('admin/admin/create')? 'active': '' }}"
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                    <a class="dropdown-item {{ Request::is('admin/signal')? 'active': '' }}"
                        href="{{ url('admin/signal') }}">
                        <i class="fas fa-fw fa-list"></i>
                        <span>All Signals</span>
                    </a>

                    <a class="dropdown-item {{ Request::is('admin/signal/create')? 'active': '' }}"
                        href="{{route('signal.create')}}">
                        <i class="fas fa-fw fa-plus-circle"></i>
                        <span>Add Signals</span>
                    </a>

                    <a class="dropdown-item {{ Request::is('admin/signal/registered-user')? 'active': '' }}"
                        href="{{ url('signal/registeredUser') }}">
                        <i class="fas fa-fw fa-list"></i>
                        <span>Reg. Users</span>
                    </a>

                    <a class="dropdown-item {{ Request::is('admin/signal/all-emails')? 'active': '' }}"
                        href="{{ url('signal/all-emails') }}">
                        <i class="fas fa-fw fa-list"></i>
                        <span>Emails</span>
                    </a>
          ...
          <span>Add Products</span></a>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                    ...
                    <a class="dropdown-item {{ Request::is('admin/category/create')? 'active': '' }}"
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                    <a class="dropdown-item {{ Request::is('admin/view-post')? 'active': '' }}"
                        href="{{ route('postdelete') }}">
                        <i class="fas fa-fw fa-list"></i>
                        <span>All Post</span>
                    </a>

                    <a class="dropdown-item {{ Request::is('admin/insert')? 'active': '' }}"
                        href="{{route('postshow')}}">
                        <i class="fas fa-fw fa-plus-circle"></i>
                        <span>Add Post</span>
                    </a>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                    <a class="dropdown-item {{ Request::is('admin/trader-category')? 'active': '' }}"
                        href="{{ route('trader-category.index') }}">
                        <i class="fas fa-fw fa-list"></i>
                        <span>Categories</span>
                    </a>

                    <a class="dropdown-item {{ Request::is('admin/trader-category/create')? 'active': '' }}"
                        href="{{route('trader-category.create')}}">
                        <i class="fas fa-fw fa-plus-circle"></i>
                        <span>Add Category</span>
                    </a>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                    <a class="dropdown-item {{ Request::is('admin/view-trader-post')? 'active': '' }}"
                        href="{{ route('traderpost') }}">
                        <i class="fas fa-fw fa-list"></i>
                        <span>All Trader Post</span>
                    </a>

                    <a class="dropdown-item {{ Request::is('admin/trader-post/insert')? 'active': '' }}"
                        href="{{route('traderadd')}}">
                        <i class="fas fa-fw fa-plus-circle"></i>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                    <a class="dropdown-item {{ Request::is('admin/forum-category')? 'active': '' }}"
                        href="{{ route('forum-category.index') }}">
                        <i class="fas fa-fw fa-list"></i>
                        <span>Categories</span>
                    </a>

                    <a class="dropdown-item {{ Request::is('admin/forum-category/create')? 'active': '' }}"
                        href="{{route('forum-category.create')}}">
                        <i class="fas fa-fw fa-plus-circle"></i>
                        <span>Add Category</span>
                    </a>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                    <a class="dropdown-item {{ Request::is('admin/view-forum-post')? 'active': '' }}"
                        href="{{ route('forumpost') }}">
                        <i class="fas fa-fw fa-list"></i>
                        <span>All Forum Post</span>
                    </a>

                    <a class="dropdown-item {{ Request::is('admin/forum-post/insert')? 'active': '' }}"
                        href="{{route('forumadd')}}">
                        <i class="fas fa-fw fa-plus-circle"></i>
        ...
        <a class="nav-link" href="{{route('traderadd')}}">
          ...
          <span>Add Trader Post</span></a>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                    <a class="dropdown-item {{ Request::is('admin/faqs')? 'active': '' }}"
                        href="{{ route('faqs.index') }}">
                        <i class="fas fa-fw fa-list"></i>
                        <span>All FAQ Post</span>
                    </a>

                    <a class="dropdown-item {{ Request::is('admin/faqs/create')? 'active': '' }}"
            ...
            <footer class="sticky-footer">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright © {{ config('app.name') }}
                            <?php echo date('Y');?>

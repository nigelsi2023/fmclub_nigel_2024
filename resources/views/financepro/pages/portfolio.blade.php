                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-md theme-bg btn-square btn-hv-dark btn-sm" href="{{ route('share.sell', $product->trade_id) }}">Sell</a>
                                                    @elseif ($product->trade_status == 'sell')
                                                    <a class="btn btn-md btn-danger btn-square btn-hv-dark btn-sm" href="{{ route('product.buy', $product->id) }}">Buy</a>
                                                    @endif
                                                </td>
                                                <td></td>
                                            </tr>

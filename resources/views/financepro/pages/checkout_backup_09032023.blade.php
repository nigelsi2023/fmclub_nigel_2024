              ...
              <ul class="list-group mb-3">
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                  <div>
                    ...
                    <!--<small class="text-muted">{{$package->p_name}}</small>-->
                  </div>
                  <?php
                    // $total = '0';
                    ...
                    // echo $total.' ';
                  ?>
                  <span style="font-size:14px;" class="text-muted"><strong><?= $total; ?></strong></span>
                </li>
                ...
                <form id="contactForm" class="needs-validation" action="JavaScript:Void(0);" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="firstName" class="labelFont">First name*</label>

...
<head>
    ...
    <link rel='stylesheet' id='bootstrap-grid-css'
        href='https://learn2.trade/wp-content/themes/twentytwenty-child/bootstrap/css/bootstrap-grid.css' media='all' />
    <link rel='stylesheet' id='bootstrap-reboot-css'
        href='https://learn2.trade/wp-content/themes/twentytwenty-child/bootstrap/css/bootstrap-reboot.css'
        media='all' />
...
<body>
    ...
    <div class="site-content-contain">
        <div class="site-content">
            <div class="banner_top" style="background: #1e222d; text-align: center; padding: 40px 0px 20px;">
                <h1 class="text-white">Your Order</h1>
            </div>
        </div>

        @if(session('message'))
            <div class="alert alert-success" style="font-size: 30px; font-weight: bold; text-align:center;">
            ...
            <div class="container" style="width:80%;">
                <div class="row">
                    ...
                    <div class="col-md-8 order-md-1">
                        ...
                        {{-- <form class="needs-validation" action="{{ url('/checkout/store') }}{{ url('/pay') }}"
                        ...
                        <form id="contactForm" class="needs-validation" action="javascript:void(0);" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-check" style="font-size: 14px;">
                                ...
                                <span>I Agree not to Misuse or Share the Trade Signals and Agree to only use for my own
                                    purpose. I understand this is not Investment Advice. Furthermore I shall not claim
                                    any analysis provided to be mine.</span>
                            </div>
    ...
    {{-- =====================< Paypal Buttons Scripts>===================== --}}
        ...
        <script
            src="https://www.paypal.com/sdk/js?client-id=AfROvAJ9RXt5AhSN1tR44ltp-yQAZ-ngt_Gb57rGbepv1UavdeAdTXbDbcEbOO7WiDB5kb9xWY_X4h7h&vault=true&intent=subscription"

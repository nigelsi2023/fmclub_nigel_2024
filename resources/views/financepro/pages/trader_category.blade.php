...
@section('meta_desc', "Regular up to date Analysis with short videos for you to know what is happenign in the
    ...
    <div class="container">
        <div class="row no-margin">
            <div class="col-md-12 text-left">
                <!-- TITLE-->
                <h2 class="text-uppercase no-margin" data-animated="fadeInLeftBig" data-animation-delay="400">Trader
                </h2>
                <!-- BREADCRUMB-->
                <ul class="breadcrumb">
                    <li>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <div class="alert alert-success">
                                ...
                                <h6 class="text-black">You have just unlocked a <b class="text-dark">50% Discount</b> on
                                    all our packages. This offer will expire in 5 days.</h6>
                                <a href="{{ route('go-vip') }}" target="_blank"
                                    class="btn btn-success text-black text-uppercase">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <p>Enter your details on the right and click the Subscribe button - and we'll send you our
                                reports by email every day.
                                <br /><strong>Our reports are released 12pm Dubai Time, and 9pm Dubai Time every
                                    day.</strong>
                            </p>
                        </div>
                        ...
                        <div class="col-md-4">
                            {{-- <form action="#" method="post"> --}}
                                <form class="input-group form-flat form-theme padding-top-10 bv-form"
                                    style="width: 100%;" name="subscribe-form" method="post"
                ...
                <div class="col-md-12">
                    ...
                    <div class="post border-bottom-style-1 bottom-margin-sm bottom-padding-sm">
                        <div class="post-title bottom-line bottom-margin-vsm">
                            <!-- POST TITLE -->
                            <h4 class="font-weight-lbold text-capitalize"><a class="text-color-hover"
                                    href="{{ route('fulltraderpost', $blog->trader_id) }}">{{ $blog->trader_name }}</a>
                            </h4>
                        </div>
                        <!-- META -->
                        <ul class="meta-list">
                            <li><i class="fa fa-user text-color ileft"></i> @if($blog->role == 'admin') Admin @else {{
                                $blog->postedby }} @endif</li>
                            <li><a href="{{ route('trader_category',str_slug($blog->category_name)) }}"><i
                                        class="fa fa-tags text-color ileft"></i> {{ $blog->category_name }}</a></li>
                            <li><i class="fa fa-comment text-color ileft"></i>
                                @php
                                $comments = DB::table('trader_comments')->where('commentable_id',
                                $blog->id)->get()->count();
                                @endphp
                            ...
                            <li>
                                <ul class="zozo-social-share-icons share-box typo-darks no-left-padding">
                                    <li class="facebook"><a
                                            onclick="window.open('https://www.facebook.com/sharer/sharer.php?u={{ route('fulltraderpost', $blog->trader_id) }}', '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes');"
                                            data-title="facebook" title="facebook">
                                            <i class="fa fa-facebook"></i></a></li>
                                    <li class="twitter"><a
                                            onclick="window.open('https://twitter.com/intent/tweet?text={{ route('fulltraderpost', $blog->trader_id) }}', '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes');"
                                            title="twitter"><i class="fa fa-twitter"></i></a></li>
                                    <li class="linkedin"><a
                                            onclick="window.open('https://www.linkedin.com/shareArticle?mini=true&url={{ route('fulltraderpost', $blog->trader_id) }}', '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes');">
                        ...
                        <div class="row" style="margin-left: 10px;">
                            ...
                            <div class="col-md-6">
                                @if (strlen(strip_tags($blog->detail)) > 200)
                                    <div class="text-justify">{!! str_limit(strip_tags($blog->detail), 350) !!}</div>
                                @else
                                    <div class="text-justify">{!! $blog->detail !!}</div>
                                @endif

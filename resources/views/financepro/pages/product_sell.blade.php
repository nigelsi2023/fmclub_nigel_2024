    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2 top-padding-sm bottom-padding-sm">
            <div class="border" style="padding: 20px 20px">
                <h2 class="productsbuytitle text-capitalize top-padding-sm">Please Enter Your Quantity of Share for Sell</h2>
                <hr>
                ...
                <div class="contact-form bottom-padding-sm">
                    <!-- Form Begins -->
                    <form method="post" action="{{ route('sell_product', $product->id) }}" class="bv-form" enctype="multipart/form-data">
                        @csrf

...
<!--Second banner-->
<section class="mysection bg-image bottom-padding-md parallax-bg typo-light" data-stellar-background-ratio="0.5" data-background="{{ asset('/images/greenbackground.jpg') }}">   
<div class="overlay-darker" style="z-index: -1;"></div>
    <div class="container">
        ...
        <div class="col-md-4 col-xs-6">
            <h2 style="text-align:left;margin-bottom: -10px;font-size: 30px;margin-top: 55px;font-weight: bold;"> Trade Details: </h2>
            ...
            <p style="margin-top: 0px;font-size: 30px;"><b>Total Profit: <?php echo $hightpipsValue; ?> Pips</b></p>
            <?php } ?>
            @endforeach
        </div>
    ...
    <div class="fs-bnr-btn2">
        <h2 style="text-align:center;margin-top: 70px;font-size: 40px;margin-bottom: -25px;font-weight: bold;"> Don't Miss Out Anymore. Join us for only $1 a day. </h2>
...
<!--First banner-->
<section class="mysection bg-image bottom-padding-md parallax-bg typo-light" data-stellar-background-ratio="0.5" data-background="{{ asset('/images/bannerbackground1.jpg') }}">   
<div class="overlay-darker" style="z-index: -1;"></div>
    <div class="container">

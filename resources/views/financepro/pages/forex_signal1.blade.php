...
<section class="mysection bg-image bottom-padding-md typo-light" data-stellar-background-ratio="0.5"
    ...
    <div class="container">
        ...
        <div class="col-md-4 col-xs-6">
            ...
            <table class="table tbb1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="color: #24cae2;font-weight: bold;font-size: 20px;">+{{$total_ppip - $total_lpip}}
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:left;">Profit Rate vs Loss Rate</td>
                        <td style="color: #24cae2;font-weight: bold;font-size: 20px;">{{(int)abs(round($total_ppip /
                            $total_lpip,2))}}x</td>
                    </tr>
            ...
            <p style="margin-top:-18px; font-weight:bold">Meaning we make {{(int)abs(round($total_ppip /
                $total_lpip,2))}}x MORE PROFIT than losses.</p>

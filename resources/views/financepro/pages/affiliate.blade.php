        ...
        <div class="container">
            <div class="row">
                <div class="banner-left-top">
                    ...
                    {{-- <!--<div class="account-buton"><a class="sg-popup-id-21056" href="{{ route('go-vip') }}" target="__blank">Join our Telegram for Free Signals!</a></div>--> --}}
                      <div class="account-buton-find-out-more"><a class="sg-popup-id-21056" href="{{ route('affiliate.registration') }}" target="__blank">Start Getting Paid</a></div>                                
...
<section style="background: #f2fffa;">
    <div class="container">
        <div class="section-text">
            ...
            <p class="text">Yout referral account comes with everything you need to efficiently spread the word and grow your income.</p>
        </div>
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mt-2 mt-md-0">
                <div class="content-list">
                    <div class="inner">
                        ...
                        <p class="text">Easy-to-repost, persuasie content accessible from your referral account.</p>
                    </div>
                </div>
                <div class="content-list mt-2">
                    <div class="inner">
                        <h2 class="title">Visitor and sales stats</h2>
                        <p class="text">See how many people are visiting your referral link and how much money you make per visitor.</p>
                    </div>
                </div>
                <div class="content-list mt-2">
                    <div class="inner">
                        <h2 class="title">Email sale notice</h2>
                        <p class="text">Share your referral link anywhere and know the instant you've made a sale.</p>
                    </div>
                </div>
                <div class="content-list mt-2">
                    <div class="inner">
                        <h2 class="title">Customer referral newsletter</h2>
                        <p class="text">Get tips on how to succeed, plus resources to share with your visitors that explain AWeber's services.</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="section-devider">
    ...
    <p class="text">With our 30 day money back guarantee, our customer have absolutely no reason not to try us. It's a win win for everyone.</p>
...
<section>
<div class="container">
    <div class="faq-detail" style="padding-block:4rem;">
        <h1>FAQ</h1>
        <h6>how more questions?<span><a href="#">Contact us.</a></span></h6>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="faq-content">
                <div class="inner">
                    <div class="single-faq">
                        <button type="button" class="collapsible">Lorem ipsum dolor sit amet consectetur adipisicing elit.</button>
                        <div class="content">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore doloremque qui possimus maiores quo perspiciatis pariatur modi harum corrupti molestiae! Libero impedit voluptates accusamus vitae a, officia quibusdam
                                esse excepturi sed sunt repellat mollitia delectus iure aliquid minima nesciunt, maiores corrupti. Quaerat in dolore minus fugiat tempore vero magnam hic illo, suscipit deleniti. Vitae, necessitatibus ab. Doloribus
                                dolor incidunt obcaecati?</p>
                        </div>
                    </div>

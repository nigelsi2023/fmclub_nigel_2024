...
<section class="newsletter-section" id="newsletterSection">
    <div class="container">
        ...
        <div class="fs-premium-plan-price">$37<p style="font-size:10px"> /month</p>
        </div>
        @else
        <div class="fs-premium-plan-price">${{$package->p_cost}}<p style="font-size:10px"> /month</p>
        </div>
        @endif --}}
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="alert alert-success">
                    ...
                    <h6 class="text-black">You have just unlocked a <b class="text-dark">50% Discount</b> on all our
                        packages. This offer will expire in 5 days.</h6>
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <p class="text-capitalize">Do you want to Learn to Trade like a Pro? Every Week we will share some
                    Trading Tips to help you Succeed.</p>
                <p>Just enter your Name and Email, and click Subscribe! </p>
            </div>

            <div class="col-md-4">
                {{-- <form action="#" method="post"> --}}
                    <form class="input-group form-flat form-theme padding-top-10 bv-form" style="width: 100%;"
                        name="subscribe-form" method="post" action="{{ route('subscribe.create') }}">
                        @csrf
                        ...
                        <span class="">
                            <button class="btn btn-default btn-block" type="submit"
                                style="background-color: #24cae2; color: #ffffff; border: 1px solid #24cae2; border-radius: 0px; float: right;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    ...
                    <br>
                    <p>At Financial Markets Club we help regular people learn to invest in the stock market by showing
                        you real life trades and how we invest ourselves.</p>
                </div>
                ...
                <div class="col-md-3 col-sm-6 footer-widgets">
                    ...
                    <address>
                        ...
                        <div class="feature-box style-3">
                            ...
                            <div class="inner-wrapper">
                                <!-- EMAIL -->
                                <p class="feature-description"><a class="active"
                                        href="mailto:info@financialmarkets.club">info@financialmarkets.club</a></p>
                            </div>
                        </div>
                    </address>
                </div>
                <div class="col-md-3 col-sm-6  footer-widgets">
                    ...
                    <form class="input-group form-flat form-theme padding-top-10 bv-form" name="subscribe-form"
                        method="post" action="{{ route('subscribe.create') }}">
                        @csrf
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input class="form-control{{ $errors->has('name') ? ' has-error' : '' }}"
                                placeholder="Enter Your Name" value="{{ old('name') }}" name="name" type="text">
                        </div>
                        ...
                        <div class="form-group has-feedback">
                            <input class="form-control{{ $errors->has('email') ? ' has-error' : '' }}"
                                placeholder="Enter Your Email" value="{{ old('email') }}" name="email" type="email">
                            @if ($errors->has('email'))
                            <span class="help-block">
                                <strong>{{ $errors->first('email') }}</strong>
                            </span>
            ...
            <div class="row">
                <div class="col-md-12">
                    <br />
                    <p>Risk Warning:The information on the this website is intended for educational purposes and is not
                        to be construed as investment advice.
                        Trading financial instruments on the stock marketcarries a high level of risk to your capital
                        and you should only trade with money you can afford to lose. Trading stocks, Forex and CFDs may
                        not be suitable for all investors, so please ensure that you fully understand the risks involved
                        and seek independent advice if necessary. Please read and ensure you fully understand our Risk
                        Disclosure.
                    </p>
                    <p>
                        Before trading, you should carefully consider your investment objectives, experience, and risk
                        appetite. Only trade with money you are prepared to lose. Like any investment, there is a
                        possibility that you could sustain losses of some or all of your investment whilst trading. You
                        should seek independent advice before trading if you have any doubts. Past performance in the
                        markets is not a reliable indicator of future performance.
                    </p>
                    <p>
                        By signing up as a member you acknowledge that we are not providing financial advice and that
                        you are making the decision on the trades you place in the markets. We have no knowledge of the
                        level of money you are trading with or the level of risk you are taking with each trade.
                    <p>
                        This website uses cookies in order to provide you with the best experience. By visiting our
                        website with your browser set to allow cookies, or by accepting our Cookie Policy notification
                ...
                <div class="col-md-6 text-right">
                    <ul class="footer-social-icons">
                        ...
                        <li class="google-plus"><a href="#" target="_blank"><i
                                    class="fa fa-google-plus text-darkest social-google-plus-hvcolor"></i></a></li>
        ...
        <div class="content-wrap">
            <div class="msg-wrap">
                <p style="margin-bottom: 4px; text-align:center">
                    <!--"DISCLAIMER: The Trade Ideas / Signals expresses my personal opinion only and where I expect markets to go. Nobody can predict the stock market for sure. Trading financial markets involves risk, and is not suitable for all Investors/ Traders . I am not responsible for any losses incurred due to your trading or anything else. The specific trades that I discuss are trades that I choose to do on my own account, sometimes I make profit sometimes I make losses. Any trades you decide to take are your own."-->
                    This website uses cookies to improve the user experience. To learn more about our cookie policy or
                    withdraw from it, please check our <a href="cookie_policy">cookie policy</a>
                </p>

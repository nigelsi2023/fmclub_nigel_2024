        ...
        <div class="col-lg-6 offset-lg-3 col-sm-6 offset-sm-3 col-12 p-3 error-main">
          ...
          <div class="row">
            ...
            <div class="col-lg-8 col-12 col-sm-10 offset-lg-2 offset-sm-1">
              ...
              <h1 class="m-0">4<span class="text-th-color">0</span>4</h1>

              <h6>Page Not Found - financialmarkets.club</h6>

              <p>The<span class="text-th-color"> Page </span> You <span class="text-th-color">Requested </span> Could <span class="text-th-color"> Not </span> Found.</p>
